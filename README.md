...
A Student project from [HTW Berlin](https://www.htw-berlin.de) in cooperation with [IXDS](https://www.ixds.com), which is a first prototype of an online staffing tool to help with the organization of tasks in different projects including the assignment of users.
